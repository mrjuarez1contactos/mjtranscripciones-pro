...
    let item: FileQueueItem | undefined;
    setFileQueue(currentQueue => {
        item = currentQueue.find(i => i.id === itemId);
        return currentQueue;
    });
...
      padding: '10px',
      borderRadius: '6px',
      border: '1px solid #dddfe2', // <-- ESTA ES LA LÍNEA QUE CORREGÍ
      fontSize: '14px',
...
                              margin: 0,
                              backgroundColor: '#fa3e3e',
                              ...(isLoading || item.status === 'processing' ? styles.buttonDisabled : {}),
                            }}
                          >
                            Quitar
                          </button>
...
                          {item.errorMessage.includes('PROHIBITED_CONTENT') ||
...
                  style={{ ...styles.button, margin: 0, backgroundColor: '#606770' }}
                >
                  Cancelar
                </button>
                <button
...
                  onKeyPress={e => {
                    if (e.key === 'Enter') {
a                     if (newInstruction && !globalInstructions.includes(newInstruction)) {
